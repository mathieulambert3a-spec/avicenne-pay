...
MATIERES = {
    "PASS": [
        ...
        "MMOK", "PHARMA", "Min SVE", "Min SVH", "Min SPS", "Min EEEA",
        "Min PHY_MECA", "Min MATH", "Min CHIMIE", "Min STAPS", "Min DROIT", "ORAUX",
    ],
    "LAS 1": [
        "Physiologie", "Anatomie", "Biologie Cell", "Biochimie", "Biostats",
        "Biophysique", "Chimie", "SSH", "Santé Publique", "ICM", "HBDV",
    ],
    "LAS 2": [
        "Microbiologie", "Biocell / Immuno", "Biologie Dev", "Enzmo / Métabo",
        "Génétique", "Physiologie", "Statistiques", "MES GSE",
    ],
}
